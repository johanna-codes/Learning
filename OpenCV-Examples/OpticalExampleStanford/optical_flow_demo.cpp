//taken from http://robots.stanford.edu/cs223b05/notes/CS%20223-B%20T1%20stavens_opencv_optical_flow.pdf
...
int main(void)
{
  ...
  */
  ...
  while(true)
  {
    ...
    */
    allocateOnDemand( &frame1_1C, frame_size, IPL_DEPTH_8U, 0 );
    /* Convert whatever the AVI image format is into OpenCV's preferred format.
    * AND flip the image vertically. Flip is a shameless hack. OpenCV reads
    * in AVIs -down by default. (No comment :-))
    */
    ...
    */
    cvCalcOpticalFlowPyrLK(frame1_1C, frame2_1C, pyramid1, pyramid2, frame1_features, 
			   ...
			   */
			   ...
			   if (current_frame >= number_of_frames - 1) return 0;//current_frame = number_of_frames - 2;
  }
}
