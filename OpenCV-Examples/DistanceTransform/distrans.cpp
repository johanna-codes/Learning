...
static void onTrackbar( int, void* )
{
    ...
    if( voronoiType < 0 )
    {
        ...
        std::cout << "painting the distance transform result" << std::endl;
        dist *= 5000;
        pow(dist, 0.5, dist);
...
add_executable( run_dist_T.exe distrans.cpp)
target_link_libraries( run_dist_T.exe ${OpenCV_LIBS} -larmadillo)
*/